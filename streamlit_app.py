...
# Custom CSS for smaller buttons and better layout
st.markdown("""
    <style>
    .stButton>button {
        height: 2em;
...
with st.sidebar:
    ...
    if st.button("Insight Conversation"):
        st.write("You selected Insight Conversation!")
    
    # Add two Sync buttons at the bottom of the sidebar
    st.markdown('<div class="sync-buttons">', unsafe_allow_html=True)
    if st.button("Sync"):
